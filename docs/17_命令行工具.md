...
![login.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/26.png)

在文本框输入access token(以tokenname:xyz...的形式)登录dashboaed

![init.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/27.png)

在初始化页面可以选择创建新的钱包，输入账户别名与钱包后即可创建新的钱包

![createaccount.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/28.png)

如果之前有备份的Keystore文件可选择从keystore文件恢复选项，恢复之前备份的钱包

![restore.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/29.png)

新建或恢复钱包后可进入主界面进行账户、交易、钱包、挖矿操作

![main.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/30.png)
