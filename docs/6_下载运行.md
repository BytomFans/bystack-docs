...
![image.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/93.png)

之后在左上角的设置里打开挖矿：

![image.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/94.png)

之后就可以看到新区块每隔 0.5 秒就被挖出一个：

![image.png](https://raw.githubusercontent.com/BytomFans/bystack-docs/gh-pages/img/95.png)
